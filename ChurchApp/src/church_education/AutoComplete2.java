...
//    }
    ...
    public static void autoComplete(final JTextField txtInput, final ArrayList<String> items) {
        ...
        txtInput.getDocument().addDocumentListener(new DocumentListener() {
            ...
            private void updateList() {
                ...
                if (!input.isEmpty()) {
                    for (String item : items) {
                        if (item != null && item.toLowerCase().startsWith(input.toLowerCase())) {
                            model.addElement(item);
                        }
                    }
                }
